...
-- 시퀀스 생성
CREATE SEQUENCE author_idx START WITH 11 INCREMENT BY 1;
CREATE SEQUENCE publisher_idx START WITH 11 INCREMENT BY 1;
CREATE SEQUENCE book_idx START WITH 69 INCREMENT BY 1;
