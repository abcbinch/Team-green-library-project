        ...
        if (loanInfo && loanInfo.length > 0) {
            loanInfo.forEach(function (loan) {
                let row = '<tr>' +
                    ...
                    '<td>' + loan.genreFullName + '</td>' +
                    '<td>' + loan.rentHistory + '</td>' +
                    '</tr>';
        ...
        if (suspensions && suspensions.length > 0) {
            suspensions.forEach(function (ban) {
                let row = '<tr>' +
                    ...
                    '<td>' + ban.startDate + '</td>' +
                    '<td>' + ban.duration + '</td>' +
                    '<td><input type="button" value="해제" onclick="releaseBan(\'' + ban.userId + '\', ' + ban.suspensionId + ')"></td>' +
                    '</tr>';
